      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row head_page">
                  <div class="col-lg-9">
                  	<h1><img src="assets/img/theNounProject/noun_104708_cc.png" class="img-circle" width="60"> Liste des utilisateurs <span><a href="javascript:history.back()">Retour</a></span></h1>
                  </div>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-3 main-chart">
                  	<?php include 'assets/include/modules/donut_users.php'; ?>
                  </div>
              </div>
              
              <div class="row">
                  <div class="col-lg-9 main-chart" style=" margin-top: 10px; ">
                  	<div class="transparent-panel" style=" padding-bottom: 25px;   margin-top: 15px;">
						<?php include 'assets/include/tableaux/all_users.php'; ?>
                    </div>
                    <p><a href="assets/exports/export_top_5_users.php?id_page=<?php echo $id_page ?>" class="btn_export" target="_blank"><i class="fa fa-file-text"></i> Exporter la liste des utilisateurs (.CSV)</a></p>
                  </div>
                  
                  
                  <div class="col-lg-3 main-chart" style=" margin-top: 25px; ">
                 	
                    <div class="white-panel pn  transparent-panel" style=" min-height: 180px; ">
                    ...
                    <div class="div_question div_question2">
  <div class="box">
