...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="popup1" class="overlay">
        <div class="popup">
            <h2><img src="http://insightlab.digitalworkshop.fr/img/screenshots/pictos.png">TOP 5 UTILISATEURS</h2>
            <a class="close" href="#">&times;</a>
            <div class="content">
               <p>La liste des Top 5 Utilisateur affiche les 5 dernières interactions des 5 profils dont le score est suppérieur à 100 points, vous pouvez modifier cette préférence en souscrivant à une offre Premium de l'Insight Lab.</p>
     ...
     <div id="popup2" class="overlay">
        <div class="popup">
            <h2><img src="http://insightlab.digitalworkshop.fr/img/screenshots/pictos.png">TOP 5 OBJETS</h2>
            <a class="close" href="#">&times;</a>
            <div class="content">
               <p>La liste des Top 5 Objet affiche les 5 dernières interactions des 5 objetss dont le score est suppérieur à 100 points, vous pouvez modifier cette préférence en souscrivant à une offre Premium de l'Insight Lab.</p>
               <p><a href="mailto:insight@digitalworkshop.fr" class="btn_popup" target="_blank">Contactez-nous pour plus d'informations</a></p>
            </div>
        </div>
    </div>
		...
		if($objCore->getSessionInfo()->isLoggedIn()){
			...
			echo '</header>';
			include 'lab/index_dashboard.php';
        }
        else{
        ?>     
