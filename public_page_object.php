...
<html lang="en">
  <head>
    ...
    <script src="assets/js/index_object/index_object.js"></script> 
  ...
  <div id="popup1" class="overlay">
        <div class="popup">
            <h2><img src="http://insightlab.digitalworkshop.fr/img/screenshots/pictos.png">LIMITATION FREEWARE</h2>
            <a class="close" href="#">&times;</a>
            <div class="content">
               <p> La version Freeware de l'Insight Lab. vous donne la possibilité d'afficher <strong>les 10 derniers "Shares", "Comments, et "Likes"</strong> de vos utilisateurs. Vous débloquerez cette limitation en souscrivant à une offre <strong>Premium Insight Lab.</strong></p>
               <p><a href="mailto:j.noyer@digitalworkshop.fr" class="btn_popup" target="_blank">Contactez-nous pour plus d'informations</a></p>
            </div>
        </div>
    </div>
