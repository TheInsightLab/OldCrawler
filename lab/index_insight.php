...
?>
      ...
      <!--sidebar start-->
      <aside>
          <?php include 'assets/include/static/menu_lab.php'; ?>
      </aside>
      <!--sidebar end-->
          ...
          <section class="wrapper">
              ...
              <div class="row">
                  <div class="col-lg-12 main-chart">
                  	<?php include 'assets/include/static/intro_insight.php'; ?>
                  </div>
              </div>
              
              <div class="row intro_insight" >
                  <div class="col-lg-12 main-chart menu_insight">
                  	<?php include 'assets/include/static/menu_insight.php'; ?>
                  </div>
              </div>
