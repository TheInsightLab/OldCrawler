...
include ROOT.'/assets/include/functions/pdo.php' ;
require ROOT . '/assets/include/functions/test_login.php';
require ROOT . '/assets/include/collect_data/main.php';
      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row head_page">
                  <div class="col-lg-12">
                  	<h1><img src="assets/img/theNounProject/noun_120061_cc.png" class="img-circle" width="60"> Connexion</h1>
                  </div>
              </div>
