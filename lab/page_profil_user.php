      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row head_page">
                  <div class="col-lg-9">
                  	<h1><img src="assets/img/theNounProject/noun_104703_cc.png" class="img-circle" width="60"> Fiche Utilisateur <span><a href="javascript:history.back()">Retour</a></span></h1>
                  </div>
              ...
              <div class="row">
                  	<?php include 'assets/include/modules/carte_user.php'; ?>
                    <?php include 'assets/include/modules/score_user.php'; ?>
              </div>
              
              <div class="row">
                  <div class="col-lg-9 main-chart" style=" margin-top: 25px; ">
                  	<?php include 'assets/include/tableaux/inter_user.php'; ?>
                  </div>
