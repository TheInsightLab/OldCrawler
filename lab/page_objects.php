      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row head_page">
                  <div class="col-lg-9">
                  	<h1><img src="assets/img/theNounProject/noun_110139_cc.png" class="img-circle" width="60"> Liste des Objets <span><a href="javascript:history.back()">Retour</a></span></h1>
                  </div>
              ...
              <div class="row">
                  <div class="col-lg-12 main-chart">
                  	<div class="transparent-panel" style=" padding-bottom: 25px;   margin-top: 15px;">
						<?php include 'assets/include/tableaux/all_object.php'; ?>
                    </div>
                    <p><a href="assets/exports/export_top_5_objects.php?id_page=<?php echo $id_page ?>" class="btn_export" target="_blank"><i class="fa fa-file-text"></i> Exporter la liste des Objets (.CSV)</a></p>
                  </div>
