      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row head_page">
                  <div class="col-lg-9">
                  	<h1><img src="assets/img/theNounProject/noun_75085_cc.png" class="img-circle" width="60"> Foire aux questions <span><a href="javascript:history.back()">Retour</a></span></h1>
                  </div>
              ...
              <div class="row">
                  <div class="col-lg-9 main-chart">
                  	<?php include 'assets/include/static/faq.php'; ?>
                  </div>
